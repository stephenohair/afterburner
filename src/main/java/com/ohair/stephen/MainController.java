...
public class MainController implements Initializable {
    ...
    private Timer timer;
    private final SimpleDateFormat sdf = new SimpleDateFormat("FF:MM:yyyy-hh:mm:ss:SSS");
    ...
    public void connect(ActionEvent event) {
        ...
        timer.scheduleAtFixedRate(timerTask, 0, config.getRefreshIntervalInMillis());
    }
    ...
    public void sendTestMessage(ActionEvent event) {
        ...
        appendTxtAreaLogOutput("sending msg [" + config.getSerialConfig() + ", msg=\"" + msg + "\"]");
